...
Shader "UdonUI/ButtonAnim/Sphere" {
    Properties {
        ...
        _Main_Text_End ("Main_Text_End", 2D) = "white" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _Main_Text_End; uniform float4 _Main_Text_End_ST;
...
////// Lighting:
                ...
                float4 _Main_Text_End_var = tex2D(_Main_Text_End,TRANSFORM_TEX(node_8405, _Main_Text_End));
                ...
                float3 finalColor = ((lerp(_Main_Text_var.rgb,_Main_Text_End_var.rgb,_Anim_var)*node_5925)+((node_5792*lerp(_LineColor_var.rgb,_LineColor_End_var.rgb,_Anim_var))+lerp(float3(0,0,0),_DownColor_var.rgb,_AnimDown_var)));
                ...
                fixed4 finalRGBA = fixed4(finalColor,((lerp(_Main_Text_var.a,_Main_Text_End_var.a,_Anim_var)*node_5925)+(node_5792*lerp(_Aphle_var,_Aphle_End_var,_Anim_var))));
