...
////// Lighting:
                ...
                float3 finalColor = ((((lerp(_Start_Color_var.rgb,_End_Color_var.rgb,_Anim_var)*(1.0 - node_7843))+(node_7843*_SphereColor_var.rgb))+lerp(float3(0,0,0),_DownColor_var.rgb,_AnimDown_var))*saturate((node_7843+lerp(_Start_Color_var.a,_End_Color_var.a,_Anim_var))));
